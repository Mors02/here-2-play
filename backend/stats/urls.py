...
from .views import DeveloperStatsView, MostSoldGamesView, BestRatedGamesView, GameRecommendedFromFriendView, RecommendationFromMostSimilarFriendView, AdminStatsView, ReportedGames, ReportedUsers
