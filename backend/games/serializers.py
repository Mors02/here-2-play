...
from .models import Game, Discount, GameAttachment, Category
...
class GameSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Game
        fields = ["id", "title", "description", "upload_date", "publisher", "price", 'image', 'uploaded_file', 'attachments', 'discounts', 'category']
